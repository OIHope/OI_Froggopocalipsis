...
namespace Core.DialogueSystem
{
    ...
    public class DialogueContainerData : ScriptableObject
    {
        ...
        [SerializeField] private DialogueBlockData _arrivalCompleteDialogueData;
        [Space]
        ...
        public DialogueBlockData GetDialogueBlock()
        {
            ...
            DialogueBlockData dBlock = gameStage switch
            {
                GameStage.Intro => _introDialogueData,
                GameStage.Arrival => _arrivalDialogueData,
                GameStage.ArrivalComplete => _arrivalCompleteDialogueData,
            ...
            return dBlock != null ? dBlock : _placeholderDialogueData;
        }
    }
}