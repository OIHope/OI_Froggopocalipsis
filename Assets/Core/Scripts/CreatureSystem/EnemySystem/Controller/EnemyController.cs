...
{
    public class EnemyController : Creature, ISimpleAttacker, IHaveMovementComponent, IInvincibility, IMoveInteractor, IAttackableTarget
    {
        [Header("Data")]
        [Space]
        ...
        private bool _isOnGoodSide = false;
        ...
        public Transform InstanceTransform => this.transform;
        ...
        private IEnumerator SpawnEntity()
        {
            ...
            _targetDetector.InitComponent(_dataAccessor);
        }
        ...
        protected override void InitComponents()
        {
            ...
            _damageDealer.InitIAttackeableTarget(this);
        ...
        public override void TakeDamage(AttackDataSO attackData, Vector3 attackVector, IDamagable target, IAttackableTarget attackerTransform)
        {
            if (Invincible) return;
            base.TakeDamage(attackData, attackVector, target, attackerTransform);
            ...
            if (!_isPassive)
            {
                _dataAccessor.Target = attackerTransform;
            }
        }
